...
graph LR
    subgraph traditional["Traditional AI Chat (Vibe Coding)"]
    ...
    style traditional fill:#ffe1e1,stroke:#ff6b6b,stroke-width:3px
    style sdd fill:#e1f5e1,stroke:#51cf66,stroke-width:3px
