# Building Station Station: Should You Use Spec-Driven Development?
...
1. **Get onboarded to the existing app** - See your attendance on the same GUI. Check the [README for onboarding instructions](../../../README.md#option-1-get-onboarded-to-the-existing-app).

2. **Fork and deploy your own** - Complete control and privacy. The [README has full deployment instructions](../../../README.md#option-2-fork-and-deploy-your-own) using GitHub Actions and GitHub Pages (all free).
